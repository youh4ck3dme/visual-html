...
export const snakeGamePrompt: PromptItem = {
  ...
  category: "games",
  prompt:
    "Create a retro arcade Snake game with a dark grid container, neon green snake, purple food, score counter, start/restart screen, and virtual D-pad buttons for mobile users.",
