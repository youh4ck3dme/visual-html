...
export const pomodoroTimerPrompt: PromptItem = {
  ...
  category: "tools",
  prompt:
    "Design a glassmorphic circular Pomodoro countdown timer with modern settings, adjustable work/break lengths, sound alerts, and a history log of completed sessions.",
